    ...
    <div class="col-md-8 mb-4">
        <div class="card shadow-sm">
            <div class="card-header">
                ...
                <a href="/dashboard/categories/create" class="btn btn-sm btn-primary mb-3 float-right" title="Add"><i class="fa fa-plus-square"></i></a>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/dashboard/categories/{{ $category->slug }}/edit" class="btn btn-sm btn-warning" title="Edit"><span class="fa fa-edit"></span></a>
